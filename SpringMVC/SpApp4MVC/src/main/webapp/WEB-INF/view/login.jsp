						...
						<div class="card body">
							<form>
								<div class="form-group" style="padding: 10px">
									<label for="exampleInputEmail1">StudentName</label> <input
										type="email" class="form-control" id="exampleInputEmail1"
										aria-describedby="emailHelp" placeholder="StudentName">
									<small id="emailHelp" class="form-text text-muted"> Nice Name...!</small>
								</div>
								
								<div class="form-group" style="padding: 10px">
									<label for="exampleInputEmail1">StudentCity</label> <input
										type="email" class="form-control" id="exampleInputEmail1"
										aria-describedby="emailHelp" placeholder="StudentCity">
								...
								<div class="form-group" style="padding: 10px">
									<label for="exampleInputPassword1">StudentAge</label> <input
										type="password" class="form-control"
										id="exampleInputPassword1" placeholder="StudentAge">
