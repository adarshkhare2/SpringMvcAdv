			...
			<div class="row">
				<div class="col-md-4 offset-md-4">
					<div class="card">
						...
						<div class="card body">
	<form action="urlforstudent">
								<div class="form-group" style="padding: 10px">
									<label>studentName</label> <input name="studentName"
								...
								<div class="form-group" style="padding: 10px">
									<label>studentCity</label> <input name="studentCity"
										type="text" class="form-control" id="exampleInputEmail1"
								...
								<div class="form-group" style="padding: 10px">
									<label">studentAge</label> <input name="studentAge"
