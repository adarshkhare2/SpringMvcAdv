			...
			<div class="row">
				<div class="col-md-4 offset-md-4">
					<div class="card">
						...
						<div class="card body">
	<form action="urlforteacher">
								<div class="form-group" style="padding: 10px">
									<label>teacherName</label> <input name="teacherName"
								...
								<div class="form-group" style="padding: 10px">
									<label>teacherCity</label> <input name="teacherCity"
										type="text" class="form-control" id="exampleInputEmail1"
										placeholder="teacherCity">
								...
								<div class="form-group" style="padding: 10px">
									<label">teacherAge</label> <input name="teacherAge"
